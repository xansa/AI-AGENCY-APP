...
export const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "Onze packages beginnen vanaf \u20AC750 per maand. Starter (website + branding): vanaf \u20AC750/mnd. Ondernemer vanaf €1.750/mnd, Marktleider (met AI-assistent) vanaf €3.500/mnd. Vergelijk dat met een fulltime digitale medewerker: die kost al snel \u20AC3.000\u2013\u20AC5.000/mnd all-in.",
    answer_en:
      "Our packages start from \u20AC750 per month. Starter (website + branding): from \u20AC750/mo. Ondernemer from €1,750/mo, AI department (with AI assistant) from €3,500/mo. Compare that to a full-time digital employee: easily \u20AC3,000\u2013\u20AC5,000/mo all-in.",
