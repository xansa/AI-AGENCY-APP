...
export const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "Onze packages lopen van \u20AC800 tot \u20AC8.000 per maand. Starter (websites + SEO): \u20AC800\u2013\u20AC1.500/mnd. Professional (+ AI + branding): \u20AC2.500\u2013\u20AC3.500/mnd. Enterprise (alle 6 diensten): \u20AC4.500\u2013\u20AC8.000/mnd. Vergelijk dat met een fulltime digitale medewerker: die kost al snel \u20AC3.000\u2013\u20AC5.000/mnd all-in.",
  ...
  {
    question: "Gebruikt Arka AI \u2014 en is dat een probleem?",
    answer:
      "Ja, ik gebruik AI als werktool \u2014 voor development, content creatie en automatisering. Maar alles wordt persoonlijk gereviewed en goedgekeurd. De strategie, het oordeel en de klantrelatie zijn altijd menselijk. AI helpt mij sneller en slimmer te werken; de kwaliteit bewaak ik zelf.",
    category: "Werkwijze",
  },
  {
    question: "Wat als het niet werkt?",
    answer:
      "Dan analyseren we de data, passen de aanpak aan en testen nieuwe oplossingen. Ik stop nooit zomaar met optimaliseren. In het uiterste geval \u2014 als het na 3 maanden echt niet de fit is \u2014 be\u00EBindigen we de samenwerking in goed overleg en lever ik alles over.",
    category: "Resultaten",
  },
];
