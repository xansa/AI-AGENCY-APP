...
const INTENTS: IntentDefinition[] = [
  // ── Prijs / investering ───────────────────────────────────────────────────
  {
    ...
    response:
      ...
      "\u2022 **Starter** · vanaf\u20AC750/mnd _(website + branding)_\n" +
      "\u2022 **Ondernemer** · vanaf €1.750/mnd _(SEO, content, leadgen, chatbot)_ Meest gekozen\n" +
      "\u2022 **Marktleider** · vanaf €3.500/mnd _(AI-assistent, automatisering, dashboards + alles)_\n\n" +
  ...
  // ── Overzicht diensten ────────────────────────────────────────────────────
  {
    ...
    response:
      ...
      "We bundelen deze diensten in **packages** (Starter, Ondernemer, Marktleider). Welke uitdaging is voor jou het meest urgent?",
  },
  ...
  // ── AI Assistent Setup (aparte dienst, /ai-assistent) ───────────────────
  {
    id: "service-ai-assistent-setup",
    keywords: [
      "ai assistent", "ai-assistent", "assistent setup", "ai assistent setup",
      "persoonlijke assistent", "digitale assistent", "morning brief",
      "inbox sorteren", "claude koppelen", "eigen assistent",
    ],
